let leftSide, rightSide, topSide, bottomSide, middle, spring, k, a, electronMembrane, holeMembrane, metal, angle, rotationSpeed, pyramids, pyramids;
let photons = [];
let holes = [];
let electrons = [];
let load;
...
function draw() {
  ...
  displayCellElements(1,1,1,1,1,1);
